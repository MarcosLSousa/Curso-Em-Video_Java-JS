...
public class telaGenio extends javax.swing.JFrame {
    ...
    public telaGenio() { // CONSTRUTOR
        initComponents();
        lblFrase.setText("<html>Vou pensar em um valor <strong>entre 1 e 5</strong>. Tente advinhar</html>");
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 130, -1, 457));

        lblFrase.setFont(new java.awt.Font("Microsoft Sans Serif", 0, 18)); // NOI18N
        lblFrase.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblFrase.setText("Frase");
        lblFrase.setToolTipText("");
        lblFrase.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        getContentPane().add(lblFrase, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 90, 130, 80));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/balao-de-fala-320x240.png"))); // NOI18N
        ...
        txtVal.setFont(new java.awt.Font("Microsoft Sans Serif", 0, 30)); // NOI18N
        txtVal.setModel(new javax.swing.SpinnerNumberModel(1, 1, 5, 1));
        getContentPane().add(txtVal, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 350, -1, -1));

        btnPalpite.setFont(new java.awt.Font("Microsoft Sans Serif", 0, 30)); // NOI18N
        ...
        getContentPane().add(btnPalpite, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 460, 180, 60));
    ...
    private void btnPalpiteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPalpiteActionPerformed
        ...
        String res = (valor == num)?"Acertou":"<html>Errou! Eu pensei no valor " + valor + "</html>";
